    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form class="mb-10 flex" method="get">
                ...
                <input value="{{ $tanggal_awal }}" name="tanggal_awal" class="appearance-none block bg-gray-200 flatpickrtext-gray-700 border border-gray-200 rounded py-3
...
focus:outline-none focus:bg-blue-500 focus:border-gray-500" id="grid-last-name">
                    ...
                    <option @if($status=='TIDAK DITERIMA' ) SELECTED @endif value="TIDAK DITERIMA">TIDAK DITERIMA</option>
                </select>
...
$item->id) }}" method="POST" class="inline-block">
                                    ...
                                    <button type="submit" class="inline-block bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 mx-2 rounded" onclick="return
...
px-4 mx-2 rounded inline-block" onclick="return confirm('Yakin akan TOLAK camaba? Proses ini tidak bisa dibatalkan.')">
                                        TOLAK
                                    </button>
                                </form>
