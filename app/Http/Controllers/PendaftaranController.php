...
class PendaftaranController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pendaftaran.index', [
            'pendaftaran' => $pendaftarans, 'tanggal_awal'
            => $tanggal_awal, 'tanggal_akhir' => $tanggal_akhir, 'status' => $status, 'q' => $q
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $data = $request->all();
        $data['ijazah_url'] = $request->file('ijazah_url')->store('assets/ijazah', 'public');
        $data['status'] = 'DAFTAR';
